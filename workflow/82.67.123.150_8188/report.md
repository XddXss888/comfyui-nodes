...
### 4. workflow_04.json
- **Prompt ID**: `a9a22052-1d6f-44b1-bf81-874685eeadec`
- **类型**: 文生图
- **节点数**: 16
- **模型** (3):
...
### 5. workflow_05.json
- **Prompt ID**: `5ea9e5cb-273e-415b-9d92-5795474983aa`
- **类型**: 文生图
- **节点数**: 16
- **模型** (3):
  - flux-2-klein-base-4b-fp8.safetensors
...
### 6. workflow_06.json
- **Prompt ID**: `18c7f878-989c-473f-89ba-c23ae547ec53`
- **类型**: 文生图
- **节点数**: 16
- **模型** (3):
  - flux-2-klein-base-4b-fp8.safetensors
...
### 7. workflow_07.json
- **Prompt ID**: `8f665cba-c060-4907-a873-b9ff010e2633`
- **类型**: 文生图
- **节点数**: 16
- **模型** (3):
  - flux-2-klein-base-4b-fp8.safetensors
...
### 8. workflow_08.json
- **Prompt ID**: `5f0f0e13-3c88-468c-b935-4a92400e1244`
- **类型**: 图生视频
- **节点数**: 32
- **模型** (6):
  - umt5_xxl_fp8_e4m3fn_scaled.safetensors
...
- **提示词**:
  - [CLIPTextEncode::text] 色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走
  - [CLIPTextEncode::text] the students are working on their group exercice. They are moving, talking
